...
class ExtracurricularTasksView extends StatelessWidget {
  final TaskService _taskService = TaskService();

  ExtracurricularTasksView({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<List<TaskModel>>(
        stream: _taskService.getTasksByType("Hoạt động ngoại khóa"),
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 20),
                  Text(
                    "Chưa có Hoạt động ngoại khóa nào",
                    style: TextStyle(
                      color: AppColors.black,
                      fontSize: 16,
                      fontWeight: FontWeight.w700,
